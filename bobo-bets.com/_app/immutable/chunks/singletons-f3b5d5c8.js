...
function N(e, t) {
    ...
    const s = e instanceof SVGAElement ? e.target.baseVal : e.target,
        o = !n || !!s || w(n, t) || (e.getAttribute("rel") || "").split(/\s+/).includes("external") || e.hasAttribute("download");
    return {
        url: n,
        external: o,
        target: s
...
function V(e) {
    let t = null,
        ...
        o = null,
        r = e;
    for (; r && r !== document.documentElement;) n === null && (n = f(r, "preload-code")), s === null && (s = f(r, "preload-data")), t === null && (t = f(r, "noscroll")), o === null && (o = f(r, "reload")), r = k(r);
    return {
...
export {
    x as I, b as P, T as S, y as a, N as b, V as c, U as d, R as e, L as f, O as g, P as h, w as i, S as j, I as k, Y as s
};